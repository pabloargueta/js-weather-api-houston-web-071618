...
let submitButton = document.getElementById('submitButton').addEventListener('click', graphData);
...
function graphData () {
  ...
  const URL = CORS_WRAPPER + "https://api.darksky.net/forecast/" + API_KEY + "/" + latitude + "," + longitude + "?exclude=currently,minutely,daily";
